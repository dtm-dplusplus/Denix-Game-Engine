...
namespace Denix
{
    ...
    void EditorSubsystem::MainMenuBar()
    {
        if (ImGui::BeginMainMenuBar())
        {
            ...
            {
                if (ImGui::Checkbox("Keyboard Logging", &Keyboard::m_KeyboardLogging)) Engine::GetConfig().
                    KeyboardLogging = Keyboard::m_KeyboardLogging;
                if (ImGui::Checkbox("Mouse Button Logging", &Mouse::m_MouseButtonLogging)) Engine::GetConfig().
                    MouseButtonLogging = Mouse::m_MouseButtonLogging;
                if (ImGui::Checkbox("Mouse Motion Logging", &Mouse::m_MouseMotionLogging)) Engine::GetConfig().
                    MouseMotionLogging = Mouse::m_MouseMotionLogging;
                if (ImGui::Checkbox("Physics Logging", &PhysicsSubsystem::GetInstance()->m_PhysicsLogging))
                {
