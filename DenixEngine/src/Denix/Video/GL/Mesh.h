...
namespace Denix
{
    ...
    public:
        ...
        void CreateMesh(const float* _vertices, const unsigned int* _indices, const unsigned int _verticesCount,
                        const unsigned int _numOfIndices) const
        {
            m_VAO->Bind();
            ...
            glVertexAttribPointer(1, 2, GL_FLOAT, GL_FALSE, sizeof(_vertices[0]) * 8,
                                  (void*)(sizeof(_vertices[0]) * 3));
            glEnableVertexAttribArray(1);

            glVertexAttribPointer(2, 3, GL_FLOAT, GL_FALSE, sizeof(_vertices[0]) * 8,
                                  (void*)(sizeof(_vertices[0]) * 6));
        ...
        void CreateViewportMesh()
        {
            ...
            glVertexAttribPointer(0, 2, GL_FLOAT, GL_FALSE, sizeof(quad[0]) * 4, nullptr);
            glEnableVertexAttribArray(0);
